...
INSERT INTO role_permissions (role_id, permission_id)
SELECT '00000000-0000-0000-0002-000000000006', id FROM permissions
WHERE code IN ('MANAGE_USERS','MANAGE_ROLES','MANAGE_SETTINGS',
               'UPLOAD_RESUME','SUBMIT_CANDIDATE','VIEW_CANDIDATES','VIEW_PIPELINE','VIEW_NOTIFICATIONS');
