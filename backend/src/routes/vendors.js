  ...
  try {
    ...
    const result = await db.transaction(async (conn) => {
      ...
      const ROLE_PERMISSIONS = {
        'Vendor Admin':     `('VIEW_JOBS','CREATE_JOB','EDIT_JOB','UPLOAD_RESUME','SUBMIT_CANDIDATE','VIEW_CANDIDATES','EDIT_CANDIDATE','VIEW_MATCHES','RUN_MATCHING','VIEW_PIPELINE','VIEW_SUBMISSIONS','VIEW_NOTIFICATIONS','MANAGE_USERS','MANAGE_ROLES','MANAGE_SETTINGS')`,
        'Vendor Recruiter': `('VIEW_JOBS','UPLOAD_RESUME','SUBMIT_CANDIDATE','VIEW_CANDIDATES','EDIT_CANDIDATE','VIEW_MATCHES','VIEW_PIPELINE','VIEW_SUBMISSIONS','VIEW_NOTIFICATIONS')`,
      };
      const createdRoles = {};
